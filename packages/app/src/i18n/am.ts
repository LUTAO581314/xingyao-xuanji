export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI መጫን አልቻለም",
  "desktop.recovery.terminated": "BAIRUI መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "BAIRUI ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUIመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "BAIRUI ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በBAIRUI",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በBAIRUI ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "BAIRUI ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በBAIRUI ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በBAIRUI ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው BAIRUI አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "BAIRUIን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ BAIRUI በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን BAIRUI በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "BAIRUI ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን BAIRUI በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUIአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) BAIRUI WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ BAIRUI።",
  ...
  "help.tabs.introduction": "BAIRUI ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የBAIRUI ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለBAIRUI ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ BAIRUI እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "settings.desktop.wsl.description": "የBAIRUI አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለBAIRUI",
  ...
  "settings.general.row.appearance.description": "BAIRUIበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "BAIRUI ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "BAIRUI ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "BAIRUI ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የBAIRUI እትም እያሄዱ ነው።",
