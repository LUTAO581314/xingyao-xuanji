export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do BAIRUI",
  ...
  "desktop.menu.ariaLabel": "Menu do BAIRUI",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o BAIRUI",
  "desktop.recovery.terminated": "A janela do BAIRUI foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O BAIRUI não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do BAIRUI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O BAIRUI não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O BAIRUI está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O BAIRUI não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do BAIRUI foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no BAIRUI.",
  ...
  "dialog.server.description": "Trocar para qual servidor BAIRUI este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o BAIRUI em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o BAIRUI em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o BAIRUI em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "O BAIRUI está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O BAIRUI está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o BAIRUI em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o BAIRUI possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O BAIRUI não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o BAIRUI novamente.",
  ...
  "help.tabs.introduction": "Agora, o BAIRUI Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do BAIRUI ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do BAIRUI",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: BAIRUI ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor BAIRUI dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do BAIRUI",
  ...
  "settings.general.row.appearance.description": "Personalize como o BAIRUI aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o BAIRUI segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o BAIRUI é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o BAIRUI iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do BAIRUI.",
