export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'BAIRUI",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'BAIRUI",
  "desktop.recovery.terminated": "La fenêtre BAIRUI s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "BAIRUI ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'BAIRUI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "BAIRUI n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'BAIRUI est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans BAIRUI.",
  ...
  "dialog.server.description": "Changez le serveur BAIRUI auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'BAIRUI dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'BAIRUI dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour BAIRUI dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez BAIRUI dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'BAIRUI puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'BAIRUI ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe BAIRUI",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'BAIRUI ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "BAIRUI inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur BAIRUI dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour BAIRUI",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'BAIRUI sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si BAIRUI suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'BAIRUI.",
