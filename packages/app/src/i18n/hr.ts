...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "BAIRUI se nije uspio učitati",
  "Prozor aplikacije BAIRUI neočekivano je zatvoren",
  "BAIRUI ne reagira",
  ...
  "Instalacija aplikacije BAIRUI nije uspjela",
  ...
  "BAIRUI nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije BAIRUI je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u BAIRUI.",
  ...
  "dialog.server.description": "Promijenite na koji se BAIRUI poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera BAIRUI u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje BAIRUI u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte BAIRUI u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte BAIRUI u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte BAIRUI",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što BAIRUI može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite BAIRUI.",
  ...
  "help.tabs.introduction": "Radna površina BAIRUI sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija BAIRUI ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku BAIRUI timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, BAIRUI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "BAIRUI Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite BAIRUI poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za BAIRUI",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako BAIRUI izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li BAIRUI slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je BAIRUI tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se BAIRUI pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju BAIRUI.",
