export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka BAIRUI",
  ...
  "desktop.recovery.loadFailed": "BAIRUI se nepodařilo načíst",
  "desktop.recovery.terminated": "BAIRUI okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "BAIRUI nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "BAIRUI není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUI aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v BAIRUI.",
  ...
  "dialog.server.description": "Přepněte, ke kterému BAIRUI serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola BAIRUI v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace BAIRUI v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace BAIRUI v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte BAIRUI do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než BAIRUI může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze BAIRUI ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu BAIRUI",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: BAIRUI zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server BAIRUI uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro BAIRUI",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled BAIRUI na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude BAIRUI následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi BAIRUI.",
