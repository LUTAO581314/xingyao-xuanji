...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI 載入失敗",
  "desktop.recovery.terminated": "BAIRUI 視窗意外終止",
  "desktop.recovery.unresponsive": "BAIRUI 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 BAIRUI",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 BAIRUI，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 BAIRUI",
  "desktop.wsl.error.updateVersion":
    "BAIRUI 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUI 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 BAIRUI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 BAIRUI 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 BAIRUI 中使用 {{provider}} 模型。",
  ...
  "dialog.directory.drives": "磁碟",
  "dialog.directory.createFolder": "新增資料夾",
  "dialog.directory.folderName": "資料夾名稱",
  "dialog.directory.createError": "無法建立資料夾",
  "dialog.directory.invalidFolderName": "請輸入有效的資料夾名稱",

  "dialog.server.title": "伺服器",
  "dialog.server.description": "切換此應用程式連線的 BAIRUI 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 BAIRUI...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 BAIRUI 已就緒。",
  "wsl.onboarding.opencodeReady": "BAIRUI 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 BAIRUI。",
  "wsl.onboarding.installOpencode": "安裝 BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 BAIRUI",
  ...
  "wsl.onboarding.wslUnavailable.description": "BAIRUI 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 BAIRUI。",
  ...
  "help.tabs.introduction": "BAIRUI Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "BAIRUI 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 BAIRUI 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：BAIRUI 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 BAIRUI 伺服器。",
  ...
  "settings.general.row.language.description": "變更 BAIRUI 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 BAIRUI 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 BAIRUI 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 BAIRUI 的主題。",
  ...
  "settings.updates.row.startup.description": "在 BAIRUI 啟動時自動檢查更新",
