export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI gagal dimuat",
  "desktop.recovery.terminated": "Jendela BAIRUI berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "BAIRUI tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi BAIRUI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.opencodeMissing": "BAIRUI belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan BAIRUI selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di BAIRUI.",
  ...
  "dialog.server.description": "Ganti server BAIRUI mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa BAIRUI di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui BAIRUI di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui BAIRUI di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI siap.",
  "wsl.onboarding.installOpencodeIn": "Instal BAIRUI di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum BAIRUI dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru BAIRUI ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim BAIRUI",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: BAIRUI belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server BAIRUI di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk BAIRUI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan BAIRUI di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah BAIRUI mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat BAIRUI diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru BAIRUI.",
