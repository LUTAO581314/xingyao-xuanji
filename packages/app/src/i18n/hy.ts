export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "BAIRUI մենյու",
  ...
  "desktop.recovery.loadFailed": "BAIRUI չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "BAIRUI պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "BAIRUI-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.opencodeMissing": "BAIRUI-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUI թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և BAIRUI-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և BAIRUI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և BAIRUI-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ BAIRUI սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է BAIRUI-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է BAIRUI-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել BAIRUI-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "BAIRUI պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք BAIRUI-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի BAIRUI-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք BAIRUI։",
  ...
  "help.tabs.introduction": "BAIRUI Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "BAIRUI-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին BAIRUI թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ BAIRUI-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք BAIRUI սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն BAIRUI",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է BAIRUI տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ BAIRUI-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է BAIRUI-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ BAIRUI-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք BAIRUI-ի վերջին տարբերակը։",
