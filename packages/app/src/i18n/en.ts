...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in BAIRUI.",
  ...
  "dialog.server.description": "Switch which BAIRUI server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Checking BAIRUI in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Updating BAIRUI in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update BAIRUI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI is ready.",
  "wsl.onboarding.installOpencodeIn": "Install BAIRUI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before BAIRUI can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of BAIRUI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the BAIRUI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, BAIRUI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the BAIRUI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for BAIRUI",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how BAIRUI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether BAIRUI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how BAIRUI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when BAIRUI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of BAIRUI.",
