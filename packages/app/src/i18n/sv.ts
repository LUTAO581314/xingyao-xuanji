export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI kunde inte läsas in",
  "desktop.recovery.terminated": "BAIRUI-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "BAIRUI svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av BAIRUI misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "BAIRUI är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUI-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i BAIRUI.",
  ...
  "dialog.server.description": "Växla vilken BAIRUI-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar BAIRUI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar BAIRUI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera BAIRUI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera BAIRUI i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan BAIRUI kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan BAIRUI igen.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av BAIRUI ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till BAIRUI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, BAIRUI stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör BAIRUI-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för BAIRUI",
  ...
  "settings.general.row.appearance.description": "Anpassa hur BAIRUI ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om BAIRUI följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa BAIRUIs tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när BAIRUI startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av BAIRUI.",
