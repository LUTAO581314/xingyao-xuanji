export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi BAIRUI",
  ...
  "desktop.recovery.loadFailed": "BAIRUI gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap BAIRUI ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "BAIRUI tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan BAIRUI gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "BAIRUI tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini BAIRUI selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam BAIRUI.",
  ...
  "dialog.server.description": "Tukar pelayan BAIRUI yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak BAIRUI dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini BAIRUI dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini BAIRUI dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang BAIRUI dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum BAIRUI boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu BAIRUI ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan BAIRUI",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, BAIRUI belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan BAIRUI dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk BAIRUI",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa BAIRUI pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada BAIRUI mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila BAIRUI dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini BAIRUI.",
