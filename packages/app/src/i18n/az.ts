export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI yüklənə bilmədi",
  "desktop.recovery.terminated": "BAIRUI pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "BAIRUI cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə BAIRUI quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "BAIRUI yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUI tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və BAIRUI-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və BAIRUI-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və BAIRUI-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu BAIRUI serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də BAIRUI yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "BAIRUI yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də BAIRUI yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də BAIRUI-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "BAIRUI-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "BAIRUI hazırdır.",
  "wsl.onboarding.installOpencodeIn": "BAIRUI-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "BAIRUI quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BAIRUI WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra BAIRUI-u yenidən açın.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "BAIRUI-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı BAIRUI komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: BAIRUI hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində BAIRUI serverini işlət.",
  ...
  "settings.general.row.language.description": "BAIRUI üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "BAIRUI-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "BAIRUI-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "BAIRUI-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "BAIRUI açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "BAIRUI-un ən son versiyasından istifadə edirsiniz.",
