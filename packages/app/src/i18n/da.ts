export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i BAIRUI.",
  ...
  "dialog.server.description": "Skift hvilken BAIRUI-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker BAIRUI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer BAIRUI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater BAIRUI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før BAIRUI kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter BAIRUI igen.",
  ...
  "toast.update.description": "En ny version af BAIRUI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til BAIRUI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, BAIRUI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør BAIRUI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for BAIRUI",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan BAIRUI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om BAIRUI skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas BAIRUIs tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når BAIRUI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af BAIRUI.",
  ...
  "desktop.recovery.loadFailed": "BAIRUI kunne ikke indlæses",
  "desktop.recovery.terminated": "BAIRUI-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af BAIRUI mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.opencodeMissing": "BAIRUI er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af BAIRUI er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "BAIRUI Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
