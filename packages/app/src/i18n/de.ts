...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in BAIRUI zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in BAIRUI zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in BAIRUI zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den BAIRUI-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "BAIRUI in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "BAIRUI wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "BAIRUI in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie BAIRUI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "BAIRUI aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "BAIRUI ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie BAIRUI in {{distro}}.",
  "wsl.onboarding.installOpencode": "BAIRUI installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor BAIRUI einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann BAIRUI erneut.",
  ...
  "toast.update.description": "Eine neue Version von BAIRUI ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem BAIRUI-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: BAIRUI unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "BAIRUI mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "BAIRUI Desktop",
  ...
  "settings.desktop.wsl.description": "BAIRUI-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für BAIRUI ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie BAIRUI auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob BAIRUI dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von BAIRUI anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von BAIRUI automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "BAIRUI ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von BAIRUI wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "BAIRUI konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das BAIRUI-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "BAIRUI reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "BAIRUI ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das BAIRUI-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "BAIRUI Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
