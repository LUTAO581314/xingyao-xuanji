export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu BAIRUI",
  ...
  "desktop.recovery.loadFailed": "Không tải được BAIRUI",
  "desktop.recovery.terminated": "Cửa sổ BAIRUI đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "BAIRUI không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được BAIRUI",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.opencodeMissing": "BAIRUI chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật BAIRUI nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do BAIRUI cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong BAIRUI.",
  ...
  "dialog.server.description": "Chuyển máy chủ BAIRUI mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra BAIRUI trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật BAIRUI trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật BAIRUI trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt BAIRUI trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi BAIRUI có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của BAIRUI ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm BAIRUI",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: BAIRUI chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ BAIRUI bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho BAIRUI",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của BAIRUI trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem BAIRUI tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi BAIRUI khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của BAIRUI.",
