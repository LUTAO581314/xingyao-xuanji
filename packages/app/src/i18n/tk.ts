export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI Resminamalar",
  ...
  "desktop.menu.ariaLabel": "BAIRUI menýusy",
  ...
  "desktop.recovery.loadFailed": "BAIRUI ýükläp bilmedi",
  "desktop.recovery.terminated": "BAIRUI penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "BAIRUI jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.opencodeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "BAIRUI täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUI tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we BAIRUI-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini BAIRUI-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini BAIRUI-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy BAIRUI serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde BAIRUI barlanýar...",
  "wsl.onboarding.updatingOpencode": "BAIRUI täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de BAIRUI täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "BAIRUI-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "BAIRUI täzeläň",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "BAIRUI taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de BAIRUI guruň.",
  "wsl.onboarding.installOpencode": "BAIRUI guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) BAIRUI WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra BAIRUI açyň.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin BAIRUI ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy BAIRUI toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, BAIRUI entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "BAIRUI serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "BAIRUI üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "BAIRUI enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "BAIRUI ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "BAIRUI-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "BAIRUI işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "BAIRUI-iň iň soňky wersiýasyny işleýärsiňiz.",
