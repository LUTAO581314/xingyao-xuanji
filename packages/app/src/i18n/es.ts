export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de BAIRUI",
  ...
  "desktop.menu.ariaLabel": "Menú de BAIRUI",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar BAIRUI",
  "desktop.recovery.terminated": "La ventana de BAIRUI se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "BAIRUI no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar BAIRUI",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "BAIRUI no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de BAIRUI finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en BAIRUI.",
  ...
  "dialog.server.description": "Cambiar el servidor de BAIRUI al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando BAIRUI en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando BAIRUI en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza BAIRUI en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala BAIRUI en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que BAIRUI pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de BAIRUI ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de BAIRUI",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: BAIRUI aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor BAIRUI dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para BAIRUI",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve BAIRUI en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si BAIRUI sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de BAIRUI.",
