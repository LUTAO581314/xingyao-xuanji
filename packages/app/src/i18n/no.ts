...
export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "BAIRUI-meny",
  ...
  "desktop.recovery.loadFailed": "BAIRUI kunne ikke lastes inn",
  "desktop.recovery.terminated": "BAIRUI-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "BAIRUI svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av BAIRUI mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "BAIRUI er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av BAIRUI er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i BAIRUI.",
  ...
  "dialog.server.description": "Bytt hvilken BAIRUI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av BAIRUI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til BAIRUI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at BAIRUI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør BAIRUI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for BAIRUI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan BAIRUI ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om BAIRUI skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når BAIRUI starter",
  ...
  "settings.updates.toast.latest.title": "BAIRUI er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av BAIRUI.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker BAIRUI i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer BAIRUI i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater BAIRUI i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer BAIRUI i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før BAIRUI kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter BAIRUI på nytt.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
