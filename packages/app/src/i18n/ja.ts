export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUIを読み込めませんでした",
  "desktop.recovery.terminated": "BAIRUIのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "BAIRUIが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUIのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはBAIRUIがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUIはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはBAIRUIがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "BAIRUIのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUIが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、BAIRUIで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してBAIRUIで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、BAIRUIで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するBAIRUIサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUIを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のBAIRUIを確認中...",
  "wsl.onboarding.updatingOpencode": "BAIRUIを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のBAIRUIを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のBAIRUIを更新してください。",
  "wsl.onboarding.updateOpencode": "BAIRUIを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のBAIRUIの準備ができました。",
  "wsl.onboarding.opencodeReady": "BAIRUIの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にBAIRUIをインストールしてください。",
  "wsl.onboarding.installOpencode": "BAIRUIをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUIがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BAIRUIでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、BAIRUIをもう一度開いてください。",
  ...
  "help.tabs.introduction": "BAIRUI Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "BAIRUIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをBAIRUIチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: BAIRUIはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "BAIRUIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でBAIRUIサーバーを実行します。",
  ...
  "settings.general.row.language.description": "BAIRUIの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのBAIRUIの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "BAIRUIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "BAIRUIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "BAIRUI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "BAIRUI は最新バージョンです。",
