export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za BAIRUI",
  ...
  "desktop.menu.ariaLabel": "BAIRUI meni",
  ...
  "desktop.recovery.loadFailed": "BAIRUI se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor BAIRUI-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "BAIRUI ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija BAIRUI-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.opencodeMissing": "BAIRUI nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje BAIRUI-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u BAIRUI-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u BAIRUI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u BAIRUI-u.",
  ...
  "dialog.server.description": "Promijeni na koji se BAIRUI server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera BAIRUI u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje BAIRUI u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj BAIRUI u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj BAIRUI u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi BAIRUI mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija BAIRUI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku BAIRUI timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: BAIRUI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni BAIRUI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u BAIRUI-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako BAIRUI izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li BAIRUI prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu BAIRUI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se BAIRUI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju BAIRUI-a.",
