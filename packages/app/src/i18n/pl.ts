export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja BAIRUI",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać BAIRUI",
  "desktop.recovery.terminated": "Okno BAIRUI zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "BAIRUI nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować BAIRUI",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program BAIRUI nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program BAIRUI jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja BAIRUI została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w BAIRUI.",
  ...
  "dialog.server.description": "Przełącz serwer BAIRUI, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie BAIRUI w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie BAIRUI w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj BAIRUI w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj BAIRUI w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim BAIRUI będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja BAIRUI ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu BAIRUI",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: BAIRUI nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer BAIRUI wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla BAIRUI",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd BAIRUI na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy BAIRUI ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji BAIRUI.",
