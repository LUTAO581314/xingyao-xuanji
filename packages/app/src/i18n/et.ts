export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI laadimine ebaõnnestus",
  "desktop.recovery.terminated": "BAIRUI aken suleti ootamatult",
  "desktop.recovery.unresponsive": "BAIRUI ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "BAIRUI pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUI värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid BAIRUI'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises BAIRUI.",
  ...
  "dialog.server.description": "Lülitage, millise BAIRUI serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "BAIRUI kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "BAIRUI värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "BAIRUI värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda BAIRUI jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige BAIRUI asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui BAIRUI saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse BAIRUI ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast BAIRUI meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, BAIRUI ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "BAIRUI Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage BAIRUI server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke BAIRUI kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas BAIRUI teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas BAIRUI järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas BAIRUI on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui BAIRUI käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse BAIRUI uusimat versiooni.",
