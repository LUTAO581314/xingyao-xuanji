...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI failed to load",
  "desktop.recovery.terminated": "BAIRUI window terminated unexpectedly",
  "desktop.recovery.unresponsive": "BAIRUI is not responding",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.opencodeMissing": "BAIRUI is not installed in this distro",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI is installed but could not run",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUI update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
