export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل BAIRUI",
  "desktop.recovery.terminated": "توقفت نافذة BAIRUI بشكل غير متوقع",
  "desktop.recovery.unresponsive": "BAIRUI لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت BAIRUI",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "BAIRUI غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث BAIRUI، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في BAIRUI.",
  ...
  "dialog.server.description": "تبديل خادم BAIRUI الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من BAIRUI في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث BAIRUI في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث BAIRUI في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت BAIRUI في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن BAIRUI من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على BAIRUI التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح BAIRUI.",
  ...
  "help.tabs.introduction": "أصبح BAIRUI Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من BAIRUI ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق BAIRUI",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن BAIRUI لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن BAIRUI نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم BAIRUI داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ BAIRUI",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور BAIRUI على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان BAIRUI يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة BAIRUI.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل BAIRUI",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من BAIRUI.",
