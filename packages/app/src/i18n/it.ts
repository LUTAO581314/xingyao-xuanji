export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in BAIRUI.",
  ...
  "dialog.server.description": "Cambia il server BAIRUI a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo BAIRUI in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento BAIRUI in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna BAIRUI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa BAIRUI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che BAIRUI possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di BAIRUI ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team BAIRUI",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: BAIRUI non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server BAIRUI all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per BAIRUI",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di BAIRUI sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se BAIRUI segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di BAIRUI",
  ...
  "settings.updates.toast.latest.title": "BAIRUI è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di BAIRUI.",
  ...
  "desktop.menu.documentation": "Documentazione di BAIRUI",
  ...
  "desktop.menu.ariaLabel": "Menu BAIRUI",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare BAIRUI",
  "desktop.recovery.terminated": "La finestra di BAIRUI si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "BAIRUI non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di BAIRUI non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "BAIRUI non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di BAIRUI è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
