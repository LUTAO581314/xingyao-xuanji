export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "BAIRUI ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno BAIRUI se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "BAIRUI se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev BAIRUI ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "BAIRUI ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev BAIRUI je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v BAIRUI.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom BAIRUI se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje BAIRUI ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje BAIRUI v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje BAIRUI ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje BAIRUI v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite BAIRUI v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite BAIRUI v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko BAIRUI doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica BAIRUI ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi BAIRUI",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, BAIRUI še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik BAIRUI znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za BAIRUI",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako BAIRUI izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali BAIRUI sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico BAIRUI.",
