...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða BAIRUI",
  "BAIRUI-glugganum var óvænt lokað",
  "BAIRUI svarar ekki",
  ...
  "BAIRUI er ekki uppsett í {{distro}}",
  "Uppfærslu BAIRUI lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í BAIRUI.",
  ...
  "dialog.server.description": "Skiptu um hvaða BAIRUI miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar BAIRUI í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir BAIRUI í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu BAIRUI í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp BAIRUI í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en BAIRUI getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan BAIRUI aftur.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af BAIRUI ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til BAIRUI teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, BAIRUI styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "BAIRUI skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu BAIRUI netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir BAIRUI",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig BAIRUI lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort BAIRUI fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig BAIRUI er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar BAIRUI ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af BAIRUI.",
