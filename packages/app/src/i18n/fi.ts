export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUIn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja BAIRUIssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja BAIRUIssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja BAIRUIssa.",
  ...
  "dialog.server.description": "Vaihda BAIRUI-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan BAIRUIa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan BAIRUIa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään BAIRUIa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään BAIRUIa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä BAIRUI jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna BAIRUI jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUIa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin BAIRUI voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten BAIRUI uudelleen.",
  ...
  "toast.update.description": "BAIRUIn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä BAIRUI-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että BAIRUI ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita BAIRUI-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda BAIRUIn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä BAIRUI näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö BAIRUI järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta BAIRUIn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun BAIRUI käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät BAIRUIn uusinta versiota.",
  ...
  "desktop.menu.documentation": "BAIRUI-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "BAIRUI-valikko",
  ...
  "desktop.recovery.loadFailed": "BAIRUIn lataaminen epäonnistui",
  "desktop.recovery.terminated": "BAIRUI-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "BAIRUI ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUIn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.opencodeMissing": "BAIRUIa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUIa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "BAIRUIn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "BAIRUI Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
