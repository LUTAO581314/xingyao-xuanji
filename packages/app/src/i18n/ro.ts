export const dict = {
  ...
  "desktop.menu.documentation": "Documentație BAIRUI",
  ...
  "desktop.menu.ariaLabel": "Meniu BAIRUI",
  ...
  "desktop.recovery.loadFailed": "BAIRUI nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra BAIRUI s-a închis neașteptat",
  "desktop.recovery.unresponsive": "BAIRUI nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea BAIRUI a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.opencodeMissing": "BAIRUI nu este instalat în această distribuție",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea BAIRUI s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în BAIRUI.",
  ...
  "dialog.server.description": "Schimbă serverul BAIRUI la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică BAIRUI în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează BAIRUI în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează BAIRUI în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează BAIRUI în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca BAIRUI să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune BAIRUI ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei BAIRUI",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, BAIRUI nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul BAIRUI în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru BAIRUI",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul BAIRUI pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă BAIRUI urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema BAIRUI.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune BAIRUI.",
