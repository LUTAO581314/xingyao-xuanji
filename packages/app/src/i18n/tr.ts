...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "BAIRUI yüklenemedi",
  "desktop.recovery.terminated": "BAIRUI penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "BAIRUI yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "BAIRUI kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.opencodeMissing": "BAIRUI bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "BAIRUI güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "BAIRUI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve BAIRUI'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak BAIRUI'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak BAIRUI'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi BAIRUI sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde BAIRUI kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "BAIRUI güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde BAIRUI güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki BAIRUI'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "BAIRUI'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde BAIRUI hazır.",
  "wsl.onboarding.opencodeReady": "BAIRUI hazır.",
  "wsl.onboarding.installOpencodeIn": "BAIRUI'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "BAIRUI'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BAIRUI'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından BAIRUI'u tekrar açın.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "BAIRUI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı BAIRUI ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: BAIRUI henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "BAIRUI Masaüstü",
  ...
  "settings.desktop.wsl.description": "BAIRUI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "BAIRUI'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "BAIRUI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "BAIRUI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "BAIRUI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "BAIRUI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "BAIRUI'un en son sürümünü kullanıyorsunuz.",
