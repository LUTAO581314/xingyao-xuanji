export const dict = {
  ...
  "desktop.menu.documentation": "BAIRUI-documentatie",
  ...
  "desktop.recovery.loadFailed": "BAIRUI kan niet worden geladen",
  "desktop.recovery.terminated": "Het BAIRUI-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "BAIRUI reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van BAIRUI is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "BAIRUI is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "BAIRUI is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "BAIRUI is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De BAIRUI-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door BAIRUI",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in BAIRUI te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in BAIRUI te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in BAIRUI te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke BAIRUI-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "BAIRUI controleren...",
  "wsl.onboarding.checkingOpencodeIn": "BAIRUI controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "BAIRUI bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "BAIRUI bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk BAIRUI bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "BAIRUI bijwerken",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer BAIRUI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat BAIRUI een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens BAIRUI opnieuw.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van BAIRUI ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het BAIRUI-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: BAIRUI ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "BAIRUI bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de BAIRUI-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor BAIRUI",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe BAIRUI eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of BAIRUI het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van BAIRUI aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer BAIRUI wordt gestart",
  ...
  "settings.updates.toast.latest.title": "BAIRUI is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van BAIRUI.",
