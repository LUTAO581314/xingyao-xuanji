...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "BAIRUI įkelti nepavyko",
  "BAIRUI langas netikėtai užsidarė",
  "BAIRUI neatsako",
  ...
  "BAIRUI įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "BAIRUI neįdiegtas distributyve {{distro}}",
  "BAIRUI naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami BAIRUI modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje BAIRUI.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius BAIRUI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius BAIRUI.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio BAIRUI serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama BAIRUI...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama BAIRUI {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas BAIRUI...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas BAIRUI {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite BAIRUI {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite BAIRUI",
  "wsl.onboarding.opencodeReadyIn": "BAIRUI yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "BAIRUI yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite BAIRUI į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite BAIRUI",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "BAIRUI neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad BAIRUI galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "BAIRUI nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite BAIRUI.",
  ...
  "help.tabs.introduction": "BAIRUI Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują BAIRUI ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą BAIRUI komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad BAIRUI dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "BAIRUI apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "BAIRUI darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite BAIRUI serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite BAIRUI ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip BAIRUI atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar BAIRUI seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite BAIRUI temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas BAIRUI",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią BAIRUI versiją.",
