export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van BAIRUI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van BAIRUI is gedownload. Wil je deze installeren en BAIRUI opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'bairui' te gebruiken.",
