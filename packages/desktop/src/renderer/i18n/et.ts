export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse BAIRUI uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUI'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „bairui” kasutamiseks taaskäivitage terminal.",
