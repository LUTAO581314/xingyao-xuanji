export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "আপনি ইতিমধ্যেই BAIRUI এর সর্বশেষ সংস্করণ ব্যবহার করছেন৷",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUI-এর {{version}} সংস্করণ ডাউনলোড করা হয়েছে, আপনি কি এটি ইনস্টল করে পুনরায় চালু করতে চান?",
  ...
  "desktop.cli.installed.message": "CLI {{path}}\n\n'bairui' কমান্ড ব্যবহার করতে আপনার টার্মিনাল পুনরায় চালু করুন।",
