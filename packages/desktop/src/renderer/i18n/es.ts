export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de BAIRUI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de BAIRUI. ¿Quieres instalarla y reiniciar?",
