export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo BAIRUIn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUIn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää BAIRUIn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'bairui'-komentoa.",
