export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ BAIRUI-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUI-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „bairui“ ბრძანების გამოსაყენებლად.",
