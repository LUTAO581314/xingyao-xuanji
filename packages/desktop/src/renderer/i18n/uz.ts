export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon BAIRUI ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUIning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'bairui' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
