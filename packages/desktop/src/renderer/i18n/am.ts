export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የBAIRUI ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከBAIRUI ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
