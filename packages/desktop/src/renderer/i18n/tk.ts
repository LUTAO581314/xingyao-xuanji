export const dict = {
  ...
  "desktop.updater.none.message": "BAIRUI-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUI-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'bairui' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
