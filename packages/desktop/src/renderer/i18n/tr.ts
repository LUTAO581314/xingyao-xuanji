export const dict = {
  ...
  "desktop.updater.none.message": "BAIRUI'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "BAIRUI'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'bairui' komutunu kullanmak için terminalinizi yeniden başlatın.",
