...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent BAIRUI from reading sensitive files",
  "Use {highlight}bairui run{/highlight} for non-interactive scripting",
  "Use {highlight}bairui --continue{/highlight} to resume the last session",
  "Use {highlight}bairui run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}bairui serve{/highlight} for headless API access",
  "Use {highlight}bairui run --attach{/highlight} to connect to a running server",
  "Keep your BAIRUI release up to date to receive the latest improvements",
  "Run {highlight}bairui auth list{/highlight} to see all configured providers",
  "Run {highlight}bairui agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}bairui github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}bairui debug config{/highlight} to troubleshoot configuration",
